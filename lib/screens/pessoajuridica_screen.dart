...
class PessoaJuridicaScreen extends StatefulWidget {
  const PessoaJuridicaScreen({Key? key}) : super(key: key);

  @override
  PessoaJuridicaScreenState createState() => PessoaJuridicaScreenState();
}

class PessoaJuridicaScreenState extends State<PessoaJuridicaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("AgroMarketLink JURIDICA"),
        actions: [
          IconButton(
